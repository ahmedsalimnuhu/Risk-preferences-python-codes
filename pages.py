    ...
    def vars_for_template(self):
        ...
        if Constants.one_choice_per_page:
            return {
                'choice_to_pay': [choice_to_pay],
                'option_to_pay': self.player.in_round(round_to_pay).option_to_pay,
                'accept_reject': _("accept") if self.player.in_round(round_to_pay).option_to_pay == "A" else _(
                    "reject"),
                'payoff': self.player.in_round(round_to_pay).payoff,
                'head_tail': self.session.vars['vchoice']
            }
        else:
            return {
                'choice_to_pay': [choice_to_pay],
...
# *** PAGE SEQUENCE *** #
# ******************************************************************************************************************** #
page_sequence = [Instructions, Instructions2, Decision]
#if Constants.instructions:
    #page_sequence.insert(0, Instructions)

#if Constants.instro2:
    #page_sequence.insert(1, Instructions2)

#if Constants.instro3:
 #   page_sequence.insert(2, Instructions3)

if Constants.results:
    page_sequence.append(Results)

if Constants.coinflip:
    page_sequence.append(Coinflip)